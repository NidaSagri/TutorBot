...
//             <div key={index} className='flex items-center border p-4 rounded-lg mb-3 justify-between'>
//                <div className='flex gap-5 items-center'>
//                     <h2 className='bg-primary w-10 h-10 rounded-full text-white text-center p-2 flex-none'>{index+1}</h2>
//                     <div>
//                         <h2 className='font-medium text-lg'>{chapter.ChapterName} {edit && <EditChapters index={index} course={course} GetCourse={GetCourse}/>}</h2>
